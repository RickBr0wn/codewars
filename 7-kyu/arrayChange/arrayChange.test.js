...
describe("arrayChange()", () => {
  it("should return the minimal number of moves needed to obtain a strictly increasing sequence from inputArray", () => {
    ...
    expect(arrayChange([3122, -645, 2616, 13213, -8069])).toBe(25559)
    expect(
      arrayChange([
        -787,
        -773,
